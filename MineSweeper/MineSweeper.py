...
class MainWindow(QMainWindow):
    ...
    def reset_game(self):
        ...
        self.pushButtonFace.setIcon(QIcon('300-3006803_windows-xp-minesweeper-face-hd-png-download.png'))
    ...
    def game_over(self):
        ...
        self.pushButtonFace.setIcon(QIcon('st,small,507x507-pad,600x600,f8f8f8.u2.png'))
                ...
                if child_elem:
                    if self.solution_map[i,j]==-1 :
                        if self.flagged_map[i,j]==0:
                            child_elem.widget().setIcon(QIcon('mine.png'))
    ...
    def game_win(self):
        ...
        self.timer_thread.stop()
        self.is_game_over=True
        self.pushButtonFace.setIcon(QIcon('EFgibyUU8AA7zMc.png'))
        for i in reversed(range(self.gridLayoutGame.columnCount())):
            for j in reversed(range(self.gridLayoutGame.rowCount())):
